...
2. solve for an affine transform which minimizes the distance between all dynamic points and their respective static
points.
...
*/
std::pair<std::vector<float>, std::vector<float>> icp(std::vector<Point*>& dynamicPointCloud,
